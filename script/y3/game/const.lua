...
const.IterKey = {
   ...
   ['ITER_ITEM_ATTACH_KEY'] = '__item_attach_key',
   ['ITER_PRE_CONDITION'] = '__iter_pre_condition',
}
...
const.MovementObstacleProcessType = {
   ['IGNORE_OBSTACLE'] = 1,
   ['NOT_THROUGH'] = 2,
   ['POINT_BEFORE'] = 4,
   ['POINT_BEHIND'] = 8,
...
const.DialogDebugType = {
   ['ERROR'] = 1,
   ['WARNING'] = 2,
   ['INFO'] = 3,
}

const.CameraMoveMode = {
   ['ACC'] = 1,
   ['SMOOTH'] = 0,
   ['DEC'] = 2,
}

const.CameraShakeMode = {
   ['LEFT_RIGHT'] = 1,
   ['UP_DOWN'] = 2,
   ['FORWARD_BACKWARD'] = 4,
   ['LR_UD'] = 3,
...
const.GlobalEventType = {
   ...
   ['GAME_ELAPSE_ONCE_BY_FRAME'] = 'ET_TIMEOUT_BY_FRAME',
   ['GAME_ELAPSE_REPEAT_BY_FRAME'] = "ET_REPEAT_TIMEOUT_BY_FRAME",

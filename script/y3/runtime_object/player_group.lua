...
function player_group.get_random_role(player_group)
    return y3.player(game_api.get_random_role_in_role_group(player_group))
end

---@return player player 玩家
---获取玩家组中第一个玩家
function player_group.get_first_role(player_group)
    return y3.player(game_api.get_first_role_in_group(player_group))
end

---@return player player 玩家
---获取玩家组中第一个玩家
function player_group.get_last_role(player_group)
    return y3.player(game_api.get_last_role_in_group(player_group))
end
